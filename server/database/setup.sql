...
VALUES
    ('Renovate Public Toilets on Main Street', 'Services', 'Renovate the public toilets located on Main Street to provide a cleaner and more comfortable facility for residents and visitors.', 'https://plus.unsplash.com/premium_photo-1661587883296-a1deb34637fc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80', 4, 10, 'pending'),
    ('Road repaired on Elm Avenue', 'Transportation', 'Pot holes on Elm Avenue are now re-tarmacced, which has improved  improve road safety and ensures a smoother driving experience for motorists.', 'https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80', 2, 15, 'complete'),
    ...
    ('New Bike Lanes introduced across the City', 'Transportation', 'Weve enhanced bike lane connectivity by adding more dedicated bike lanes and connecting existing ones to create a safer and more convenient cycling network throughout the city.', 'https://images.unsplash.com/photo-1587740908141-4bad3ba9c6f7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fGJpa2UlMjBsYW5lfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60', 7, 14, 'complete'),
    ('Establishing Community Mental Health Support Center', 'Services', 'We have plans to Establish a community mental health support center to provide counseling, therapy, and resources for individuals and families facing mental health challenges.', 'https://plus.unsplash.com/premium_photo-1661779028333-026d2ee7f840?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80', 9, 0, 'in-progress'),
    ...
    ('Expand After-School Art Programs for Children', 'Services', 'Expand after-school art programs for children by offering diverse art classes, workshops, and opportunities for creative expression.', 'https://images.unsplash.com/photo-1531796311868-83672cd144f3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80', 6, 0, 'denied'),
